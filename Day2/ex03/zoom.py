...
def ft_zoom(path: str):
    """
    This functions zooms into provided picture.
    """
    try:
        ...
        new_image = image_pillow.crop((left_point,
                                       top_point, right_point, bottom_point))
        widht1, height1 = new_image.size
        out = new_image.resize((widht1 * 2, height1 * 2),
        ...
        print(f"New shape after slicing: \
              {arraynp_channels.shape} or {arraynp.shape}")
